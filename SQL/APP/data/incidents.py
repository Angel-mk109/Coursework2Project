...
from SQL.APP.data import schema
from SQL.APP.data import create_all_tables, migrate_users_from_file, load_all_csv_data, DB_PATH
from SQL.APP.services.user_service import register_user, login_user
...
def insert_incident(date, incident_type, severity, status, description, reported_by=None):
    ...
    cursor = conn.cursor()
    cursor.execute("""
        INSERT INTO intelligence_platform 
